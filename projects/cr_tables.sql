...
insert into Movies_rented values (1, 1, 1, '09-12-2017', NULL, 21.99, NULL, 2.99, NULL, NULL, NULL);
insert into Movies_rented values (2, 2, 2, '09-06-2017', '09-26-2017', 80.75, 5.55, 2.99, 20.11, 7.99, 2.10);
...
insert into Movies_rented values (5, 5, 5, '09-15-2017', NULL, 33.45, NULL, 7.99, NULL, NULL, NULL);
...
SELECT mov.Movie_title, ren.Date_rented
  from Movie mov, Movies_rented ren, Distributor_catalog dis, Movie_inventory movieInv
  where
	mov.Movie_ID = dis.Movie_ID
  And	
	dis.Distributor_catalog_ID = movieInv.Distributor_catalog_ID
  And
    movieInv.Movie_inventory_ID = ren.Movie_inventory_ID
  And
    ren.Date_rented >= to_char(trunc(sysdate) - 30, 'MM-DD-YYYY')
...
DELETE FROM Movies_rented WHERE Rental_ID = 5;
